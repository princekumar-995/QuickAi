...
import { useNavigate } from 'react-router-dom'  
 // ✅ You missed this import

 import { assets } from '../assets/assets'   // ✅ You forgot to import this
...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative flex flex-col items-center justify-center w-full min-h-screen bg-[url("/gradientBackground.png")] bg-cover bg-no-repeat bg-center'>
